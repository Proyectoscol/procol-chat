...
import ContactsFormWithAdvisor from 'dashboard/components-next/Contacts/ContactsForm/ContactsFormWithAdvisor.vue';
...
<template>
  ...
  >
    <ContactsFormWithAdvisor ref="contactsFormRef" @update="createNewContact" />
    <template #footer>
